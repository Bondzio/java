...
/* Create Tables */
select * from tb_player where team='Arsenal';

CREATE TABLE tb_game
(
	game_date date NOT NULL,
	homeTeamName varchar2(50) NOT NULL,
	awayTeamName varchar2(50) NOT NULL,
	homeTeamScore varchar2(10),
	awayTeamScore varchar2(10),
	stadium varchar2(40)
);

ALTER TABLE tb_game ADD CONSTRAINT tb_game_PK PRIMARY KEY ( game_date, homeTeamName, awayTeamName ) ;
...
ALTER TABLE tb_team ADD constraint teamname_uk unique(team_name_kr);
...
select * from tb_player where team='Arsenal';                                  
UPDATE TB_TEAM SET MANAGER='David Moyes' WHERE TEAM_NAME='Sunderland';

UPDATE TB_TEAM SET MANAGER='Bob Bradley' WHERE TEAM_NAME='Swansea City';

UPDATE TB_TEAM SET MANAGER='Sean Dyche' WHERE TEAM_NAME='Burnley';

UPDATE TB_TEAM SET MANAGER='Walter Mazzarri' WHERE TEAM_NAME='Watford';

UPDATE TB_TEAM SET MANAGER='Marco Silva' WHERE TEAM_NAME='Hull City';

UPDATE TB_TEAM SET MANAGER='Aitor Karanka' WHERE TEAM_NAME='Middlesbrough';

UPDATE TB_TEAM SET MANAGER='Ronald Koeman' WHERE TEAM_NAME='Everton';
