...
public class TeamVO {
	...
	public String toString() {
		return "TeamVO [team_name=" + team_name + ", team_name_kr=" + team_name_kr + ", lastResult=" + lastResult
				+ ", teamRankingGroup=" + teamRankingGroup + ", teamCode=" + teamCode + ", gainGoal=" + gainGoal
				+ ", gameCount=" + gameCount + ", gainPoint=" + gainPoint + ", foul=" + foul + ", lost=" + lost
				+ ", won=" + won + ", rank=" + rank + ", drawn=" + drawn + ", manager=" + manager + "]";
	}
