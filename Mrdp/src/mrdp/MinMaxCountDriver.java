...
public class MinMaxCountDriver {
	...
	public static class SOMinMaxCountMapper extends Mapper<Object, Text, Text, MinMaxCountTuple> {
	...
	public static class SOMinMaxCountReducer extends Reducer<Text, MinMaxCountTuple, Text, MinMaxCountTuple> {
